                ...
                <div className="prose prose-gray max-w-none">
                  <section className="mb-8">
                    ...
                    <p className="text-[#37322F] text-base leading-6 font-sans mb-4">
                      By accessing and using FlowAI (&quot;the Service&quot;),
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-[#37322F] text-base leading-6 font-sans mb-4">
                      FlowAI is a platform for building, deploying, and managing
                      AI agent workflows. The service provides tools and infrastructure
                      to help users create intelligent multi-agent systems through natural
                      language interfaces.
                    </p>
                  </section>
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-[#37322F] text-base leading-6 font-sans mb-4">
                      ...
                      functionality are owned by FlowAI and are protected by
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-[#37322F] text-base leading-6 font-sans mb-4">
                      In no event shall FlowAI be liable for any indirect,
