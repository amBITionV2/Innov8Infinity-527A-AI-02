...
export function ChatInterface({
  ...
  const initialMode = searchParams.get("mode") as WorkflowMode | null;
  const {
    user,
  ...
  const [workflowMode, setWorkflowMode] = useState<WorkflowMode>(initialMode || "ai");
  ...
  return (
    <div className="relative h-full flex flex-col">
      ...
      <div className="flex-shrink-0">
        <WorkflowModeSelector mode={workflowMode} onModeChange={setWorkflowMode} />
      </div>
